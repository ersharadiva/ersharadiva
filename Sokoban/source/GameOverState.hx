...
class GameOverState extends FlxState
{
	...
	private var _btnRetry:FlxButton;	// button retry on the same level
	...
	override public function create():Void 
	{
		...
		_btnMainMenu = new FlxButton(170, 200, "Main Menu", goMainMenu);
		add(_btnMainMenu);		
		
		_btnRetry = new FlxButton(70, 200, "Retry", goRetry);
		add(_btnRetry);
